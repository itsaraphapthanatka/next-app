  ...
  const handleFilterSearch = () => {
    ...
    const event = new CustomEvent('assignTableReload', {
      detail: { 
        ...
        projectTypeIds: Array.isArray(values.propertyType) ? values.projectTypeIds.map(String) : [],
        bootedProppit: values.bootedProppit ?? 0,
        vipStatusIds: Array.isArray(values.vipStatus) ? values.vipStatusIds.map(String) : [],
